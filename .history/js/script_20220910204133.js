...
addButtons.forEach(addButton => {
    addButton.onclick = function (e){
      ...
      buttonParent= e.currentTarget.parentElement,
          ...
          if (addedItems != []){
            addedItems.fsomeind(addedItem => buttonCart.dataset.id == addedItem.dataset.id )
            console.log('exsist')
            addedItems.forEach (addedItem => {
                let leftCloumnInAddItem = addedItem.firstElementChild,
                     imgOfAddItem = leftCloumnInAddItem.firstElementChild
                if (buttonCart.dataset.id == addedItem.dataset.id){
                    console.log('exsist')
                }else{
                    shoppingCartContainer.innerHTML += `<div class="order-section" data-id="${buttonCart.dataset.id}}>
                    <div class="column-left">
                    <img src="${cartImg.src}">
                    </div>
                    <div class="column-center">
                    ...
                    console.log ("not exisist")
                    console.log (shoppingCartContainer)
                }
            })

          }else{
            shoppingCartContainer.innerHTML += `<div class="order-section">
            <div class="column-left">
            <img src="${cartImg.src}">
            </div>
            <div class="column-center">
